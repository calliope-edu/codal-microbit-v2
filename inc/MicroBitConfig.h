...
// 0: Feature disabled
// 1: Feature enabled. Six taps of reset button will reset the micro:bit to blank mode.
#ifndef MICROBIT_SIX_TAP_RESET_TO_BLANK_MODE
    #define MICROBIT_SIX_TAP_RESET_TO_BLANK_MODE               1
#endif
