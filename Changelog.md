...
## [v0.3.5](https://github.com/calliope-edu/codal-microbit-v2/compare/v0.3.2_ble_fix2...v0.3.5)
 ...
 - Updated the Changelog (v0.2.71) (by Github Actions)
 ...
 - Updated the Changelog (v0.3.0) (by Github Actions)
 ...
 - Updated the Changelog (v0.3.3) (by Github Actions)
 ...
 - Updated the Changelog (v0.3.4) (by Github Actions)
 - Updated the Changelog (by Github Actions)
 - MicroBitDisplay: move display refresh timer ownership to MicroBit (#515) (by Mannu Lambrichts)
 - Snapshot v0.3.5 (by Carlos Pereira Atencio)

### codal-core ([4cc9143...e6b061f](https://github.com/calliope-edu/codal-core/compare/4cc9143f5c56e77c04b5cd53c02e67969598914c...e6b061f2a6d8977811e3025da387d3007e5796f2))
 ...
 - Move delete listener callback (#189) (by Thomas Ball)
...
## [v0.3.2_ble_fix1](https://github.com/calliope-edu/codal-microbit-v2/compare/v0.2.69...v0.3.2_ble_fix1)
 ...
 - add _ID to compat.h (by hugo)
 - update Pinout and signal names for the second prototype. PIN_IDs were only created where necessary, IDs for P17 and P18 were reused from microbit pin IDs (by fabianhugo)
 - updates compat with new names (by fabianhugo)
 - uBit pins stay, only calliope pins are added, pxt makes the new connections, pin movings (by fabianhugo)
 - fix bug (by fabianhugo)
 - fix (by fabianhugo)
 - update data logging files (by Amerlander)
 - align pin definitions (by Amerlander)
 - Refactor pin definitions and remove unused pins. (by Amerlander)
 - Refactor motor pin names for Calliope mini3 (by Amerlander)
 - Refactor Pin names (by Amerlander)
 - update pins (by Amerlander)
 - update pin (by Amerlander)
 - Build logfs file (by Amerlander)
 - link codal core to calliope-edu (by Amerlander)
 - link codal core to calliope-edu (by Amerlander)
 - update target lock (by Amerlander)
 - upgrade v0.2.55 to 0.2.57 (by Amerlander)
 - update logfs styles (by Amerlander)
 - turn off rgb led on init (by Amerlander)
 - Update ble device name (by Amerlander)
 - BLE: Simplify device name string creation (by Amerlander)
 - update MicroBitIO files (by Amerlander)
 - update MicroBitIO files (by Amerlander)
 - turn off rgb leds (by Amerlander)
 - turn off rgbleds 2 (by Amerlander)
 - update logfs (by Amerlander)
 - fix seedRandom (by Amerlander)
 - fix seedRandom (by Amerlander)
 - update workflows (by Amerlander)
 - set codal core branch to pxt-calliope (by Amerlander)
 - revert seedRandom (by Amerlander)
 - Update logfs header and codal-core (by Amerlander)
 - upstream mb0.2.69 (by Amerlander)
 - turnsoff RGB before deepsleep and off (by fabianhugo)
 - Reduce pairing success confirmation img from 15 seconds to 2 seconds (by Juri Wolf)
 - Refactor compass calibration: - remove text - add animation (by Juri Wolf)
 - Merge branch 'mb-v0.3.2' into upgrade-v0.2.69-to-v0.3.2 (by Juri Wolf)
 - Add additional I/O pin Aliases (P16, P17, P19, P20) to MicroBitIO constructor (by Juri Wolf)
 - Add additional I/O pin aliases (P16, P17, P19, P20) to MicroBitIO (by Juri Wolf)
 - remove target_disable_irq() (by Juri Wolf)

### codal-core ([c43b899...4cc9143](https://github.com/lancaster-university/codal-core/compare/c43b89936ed72c022f2649f5540a9a74ef48fd04...4cc9143f5c56e77c04b5cd53c02e67969598914c))

 - fixes accelerometer and compass rotations (by fabianhugo)
 - upstream mb c43b89936ed72c022f2649f5540a9a74ef48fd04 (by Amerlander)
 - Apply Merge branch 'mb-v0.3.2' into upgrade-c43b89936e_to_8c8366f9a1e (by Amerlander)
